...
A personal reading app for learning languages. Upload a PDF, EPUB, or plain text file, read it in the browser, and select any word or phrase to get an instant translation and a grammar breakdown.
...
- **Backend:** FastAPI + Python — PyMuPDF for PDF extraction, ebooklib/BeautifulSoup for EPUB
